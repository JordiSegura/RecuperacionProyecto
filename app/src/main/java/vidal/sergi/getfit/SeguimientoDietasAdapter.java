...
public class SeguimientoDietasAdapter extends RecyclerView.Adapter<SeguimientoDietasAdapter.ViewHolder> {
    ...
    public SeguimientoDietasAdapter(LocalDate dias) {
        this.dias = dias;
    }
    ...
    public SeguimientoDietasAdapter(ArrayList<String> mImageNames, ArrayList<String> mImages, Context mcontext, String intento, String diferenciaDias) {
        this.diferenciaDias = diferenciaDias;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_seguimiento_dietas_adapter, parent, false);
        ...
        database.getReference().child("CurrentUser").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    database.getReference().child("users/" + usu + "/finDieta").addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            Log.d(TAG, "onDataChange: finDieta " + dataSnapshot.getValue().toString());
                            ...
                            Log.d(TAG, "onDataChange: 333333333333333333333 " + days);
                            usersRef2.child(usuario).child("diferenciaDias2").setValue(days);
                                                        ...
                                                        database.getReference().child("CONTADOR_TRUE/").addValueEventListener(new ValueEventListener() {
                                                            ...
                                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                                ...
                                                                if (dataSnapshot.getValue().toString().contains("1") && holder.imageName.getText().equals(miDia)   ){
                                                                  ...
                                                                  //  holder.imageName2.setBackgroundColor();
                                                                    usersRef7.child(miDia).setValue("bien");

                                                                }

                                                               /* else if (dataSnapshot.getValue().toString().contains("0") && holder.imageName.getText().equals(miDia)){
                                                             //       holder.imageName.setClickable(false);
                                                                   // holder.image.setClickable(false);

                                                                    holder.imageName2.setText(" mal");
                                                                }*/
                                                            }
        ...
        holder.imageName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                while (true) {
                    ...
                    intent = new Intent(mcontext, LunesActivity.class);
